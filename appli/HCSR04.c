...
//Si La priode de mesure est infrieure, elle ne sera respecte que si le capteur  prsent un cho moins long.
...
/*
 * Fonction de dmonstration permettant d'aprhender l'utilisation de ce module logiciel
 * @pre	cette fonction doit tre appele en tche de fond
 * @pre	il faut avoir pralablement initialis un port srie (cette fonction utilise printf)
...
HAL_StatusTypeDef HCSR04_get_distance(void)
{
	typedef enum
	{
		INIT,
...
/*
 * @brief	Cette fonction permet de rcuprer la distance mesure par le capteur dont l'id est fournie
 * @param	id : identifiant du capteur
 * @param	distance : pointeur vers une case mmoire qui sera renseigne par cette fonction
