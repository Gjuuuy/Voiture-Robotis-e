...
void MOTOR_demo(void)
{
	...
	left_motor_id = MOTOR_add(GPIOA, GPIO_PIN_10, GPIOA, GPIO_PIN_11);	//le choix des broches est stratégiques : elles doivent correspondre à des TIMERS !
	right_motor_id = MOTOR_add(GPIOB, GPIO_PIN_13, GPIOB, GPIO_PIN_14);
	...
	while(1)
	{
		...
		duty = (duty<1000)?duty+100:-1000;		//duty augmente de 10 en 10 jusqu'à +100 et rejoint ensuite -100
